...
SCENARIO("compilation tests")
{
  ...
  static_assert(std::is_same_v<ezy::extract_features_t<Simple>, ezy::typelist<>>);
  static_assert(std::is_same_v<ezy::extract_features_t<SimpleRef>, ezy::typelist<>>);
  static_assert(std::is_same_v<ezy::extract_features_t<OneFeature>, ezy::typelist<ezy::features::addable>>);
  static_assert(std::is_same_v<ezy::extract_features_t<MoreFeatures>, ezy::typelist<ezy::features::addable, ezy::features::subtractable, ezy::features::equal_comparable>>);
  ...
  static_assert(std::is_same_v<
      ezy::rebind_features_from_typelist_t<Simple, ezy::typelist<ezy::features::addable>>,
      OneFeature
      >);
